...
export default function ToggleDrawer() {
  ...
  let url =
    router.asPath.indexOf("/", 1) > 0
      ? router.asPath.slice(0, router.asPath.indexOf("/", 1))
      : router.asPath;
                ...
                <StyledItem key={index}>
                  <ListItemButton
                    sx={{
                      ...
                      backgroundColor:
                        url === item.link ? "var(--palette-02)" : "transparent",
...
const menuItems = [
  ...
  {
    text: "Kế hoạch điều trị",
    icon: <SettingsRounded />,
    link: "/quan-ly-chi-dinh",
  },
  {
    text: "Thanh toán",
    icon: <SettingsRounded />,
    link: "/DanhSachThanhToan",
  },
  {
    text: "Quản lí điều trị",
    icon: <SettingsRounded />,
    link: "/quan-ly-dieu-tri",
  },
  {
    text: "Đăng xuất",
    icon: <LogoutOutlined />,
