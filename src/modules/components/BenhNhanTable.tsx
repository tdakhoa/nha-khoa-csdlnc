...
export default function EnhancedTable() {
  ...
  let [patients, setPatients] = React.useState<Array<any>>([]);
  ...
  const handleSelectAllClick = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (event.target.checked) {
      const newSelected = patients.map((n) => n.MaBN);
          ...
          >
            ...
            <TableBody>
              {stableSort(patients, getComparator(order, orderBy))
                ...
                .map((row: any, index) => {
                  const isItemSelected = isSelected(row.MaBN);
                  ...
                  return (
                    ...
                    >
                      <TableCell padding="checkbox">
                        <Checkbox
                          onClick={(event: any) => handleClick(event, row.MaBN)}
                          color="primary"
